...
这个项目解决一件很具体的事：把“报告原文（PDF/EPUB）”稳定地转成“大模型更容易处理的 Markdown”，再通过专用 GPT 《[报告](https://chatgpt.com/g/g-6958c62859308191a56c55be410caad7-bao-gao)》 生成“结构化、简化版的报告笔记”，最终形成从原始文档到笔记的可复用工作流。
...
* 专用GPT：《[报告](https://chatgpt.com/g/g-6958c62859308191a56c55be410caad7-bao-gao)》
...
分段输出要解决两个问题：一是“怎么知道写到哪了”，二是“怎么继续且不重写/不漏写”。这个项目把“续写控制信息”显式编码为 Hook，放进每段输出的末尾。
